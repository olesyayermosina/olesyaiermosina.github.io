...
<head>
    ...
    if (in_array($var, $styleContainer)){
        echo '<link rel="stylesheet" href="css/container.css">';
    } elseif (in_array($var, $styleDegustation)){
        echo '<link rel="stylesheet" href="css/degustation.css">';
    } elseif (in_array($var, $styleDelivery)){
        echo '<link rel="stylesheet" href="css/delivery.css">';
    } elseif (in_array($var, $styleInform)){
        echo '<link rel="stylesheet" href="css/inform.css">';
